...
INPUT_PATH = (
    ...
    / "time_series"
    / "traffic"
    / "beijing_traffic_congestion_2019_2024.xlsx"
)
OUTPUT_DIR = ROOT / "outputs" / "traffic_meta_lstm_attention"
...
scaler_path = OUTPUT_DIR / "experiment16_scaler.gz"
joblib.dump(scaler, scaler_path)
print(f"已保存多变量数据缩放器: {scaler_path}")
...
model_path = OUTPUT_DIR / "experiment16_lstm_attention_traffic_model.h5"
